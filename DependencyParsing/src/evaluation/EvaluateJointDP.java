...
public class EvaluateJointDP {

	public static void main(String[] args) throws Exception {
		
		boolean bZhangYue = false; 
		
		if(args[2].equalsIgnoreCase("zy")) bZhangYue = true;
		...
		//{
			...
			evaluateDep(sdpCorpusReader1.m_vecInstances,sdpCorpusReader2.m_vecInstances, writer);
		//}
		//else if(iType == 1)
		//{
