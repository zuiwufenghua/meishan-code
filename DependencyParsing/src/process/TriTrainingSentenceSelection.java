...
public class TriTrainingSentenceSelection {
	...
	public static void main(String[] args) throws Exception {
		...
		if(subFilenames1.length != subFilenames2.length)
		{
		...
		for (String keyIndex : subFilenames1Info1.keySet()) {
			if(!subFilenames2Info2.containsKey(keyIndex))
			{
			...
			processOneFile(inputFile1, inputFile2, writer, threshold);			
		}
		System.out.println("Finished!");
		writer.close();
	}
	
	public static void processOneFile(String inputFile1, String inputFile2, PrintWriter writer, int threshold) throws Exception{
		// TODO Auto-generated method stub
		System.out.println("Processing file " + inputFile1 + " and " + inputFile2 + " ......");
		...
		if(totalInstances != totalInstances2) 
		{
		...
		for(; i < totalInstances; i++)
		{
			...
			if(sent_num_word_all_nopunc_dep_correct_cur == 1)
			{
				List<String> outputResult = new ArrayList<String>();
				other.toGoldListString(outputResult);
