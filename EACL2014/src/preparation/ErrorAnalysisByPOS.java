...
public class ErrorAnalysisByPOS {
	...
	public static void Evaluate(PrintWriter writer, 	List<Sentence> goldSentences, 
		...
		for(int idx = 0; idx < goldNum; idx++)
		{
			...
			int[] evalRes = recobypos(curPOS, goldSentences.get(idx), predSentences.get(aligns[idx]));
