...
// NRVec, NRHeap, NRMat, NRMat3d, NRMat4d are all borrowed from "Numerical Recipes in C++" by Willam H. Press et al.
...
template<typename T>
NRMat4d<T> & NRMat4d<T>::resize(const int n, const int m, const int k,
		const int l) {
