...
//#ifdef _WIN32
//		typedef HashMap<const char *, T, CharArrayHashFunc> _internal_map_t;
//#else
//		typedef HashMap<const char *, T, CharArrayHashFunc, CharArrayEqualFunc> _internal_map_t;
//#endif
#ifdef _WIN32
	typedef stdext::hash_map<const char *, T, CharArrayHashFunc> _internal_map_t;
#else
	typedef __gnu_cxx ::hash_map<const char *, T, CharArrayHashFunc,
			CharArrayEqualFunc> _internal_map_t;
#endif
...
void loadStringIntegerMap(StringMap<int> & map, const std::string & fileName);
