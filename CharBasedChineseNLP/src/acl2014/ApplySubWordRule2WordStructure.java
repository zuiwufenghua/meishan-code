...
public class ApplySubWordRule2WordStructure {
	...
	public static void main(String[] args)throws Exception{
		...
		Map<String, String> subwordHead = new HashMap<String, String>();
			...
			try
			{
				...
				if(CFGWordStructureNormalize.checkWordStructure(normalizedTree))
				{
					...
					for(Tree<String> oneSubWordTree : allNonTerminals)
					{
						...
						if(theLeftSubWord.equals(theRightSubWord))continue;
						...
						if(!subwordHead.containsKey(theSubWord) ||  subwordHead.get(theSubWord).equals(theSubWordHeadLabel))
						{
							subwordHead.put(theSubWord, theSubWordHeadLabel);
						}
						else
						{
							System.out.println(theSubWord);
						}
					}
				}
			}
				...
				if(CFGWordStructureNormalize.checkWordStructure(normalizedTree))
				{
					...
					for(Tree<String> oneSubWordTree : allNonTerminals)
					{
						...
						*/
						...
						else if(subwordHead.containsKey(theSubWord))
						{
							if(subwordHead.get(theSubWord).equals("z") && thePOS.equals("NR"))
							{
								bValid = false;
							}
							oneSubWordTree.setLabel(thePOS + "#" + subwordHead.get(theSubWord));
						}						
