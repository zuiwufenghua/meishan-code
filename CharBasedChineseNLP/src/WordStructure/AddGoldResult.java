...
public class AddGoldResult {
	...
	public static void main(String[] args) throws Exception {
		...
		removeDulpication(args[0], wordposanno, allPOS, false);
		
		removeDulpication(args[1], wordposanno, allPOS, true);
		
		List<Entry<String, String>> chapossortlist = new ArrayList<Entry<String, String>>(wordposanno.entrySet());
