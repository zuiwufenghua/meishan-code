...
public class GrammarTrainer {
	...
	public static class Options {
		...
		@Option(name = "-trainFile", usage = "Path to training Corpus (Default: null)")
		public String trainFile = null;
		
		@Option(name = "-devFile", usage = "Path to development Corpus (Default: null)")
		...
		@Option(name = "-treebank", usage = "Language:  WSJ, CHINESE, GERMAN, CONLL, SINGLEFILE, FOLDER (Default: ENGLISH)")
	...
	public static void main(String[] args) throws Exception{
		...
		// int lang = opts.lang;
		System.out.println("Loading training trees from " + opts.trainFile
				+ " and using language " + opts.treebank);
		System.out.println("Loading development trees from " + opts.devFile
				+ " and using language " + opts.treebank);
		...
		List<Tree<String>> orgTrainTrees = readTreesFromSingleFile(opts.trainFile);
		List<Tree<String>> orgDevTrees = readTreesFromSingleFile(opts.devFile);
		System.out.println(String.format("There are total %d training trees and %d development trees", orgTrainTrees.size(),
				orgDevTrees.size()));
		List<Tree<String>> trainTrees = Corpus.binarizeAndFilterTrees(
				orgTrainTrees, VERTICAL_MARKOVIZATION,
		...
		List<Tree<String>> validationTrees = Corpus.binarizeAndFilterTrees(
				orgDevTrees, VERTICAL_MARKOVIZATION,
				HORIZONTAL_MARKOVIZATION, maxSentenceLength, binarization,
				manualAnnotation, VERBOSE);
	...
	public static List<Tree<String>> readTreesFromSingleFile (String corpusFile) throws Exception
	{
